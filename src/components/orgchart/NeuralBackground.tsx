  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
      ...
      <motion.div 
        ...
        className="absolute top-[20%] left-[10%] w-64 h-64 bg-zinc-500/10 rounded-full blur-[100px]"
      />
      <motion.div 
        animate={{ 
          y: [0, 30, 0], 
        ...
        className="absolute bottom-[20%] right-[10%] w-96 h-96 bg-zinc-400/10 rounded-full blur-[100px]"
      />
      <motion.div 
        animate={{ 
          x: [0, 40, 0], 
        ...
        className="absolute top-[40%] right-[30%] w-72 h-72 bg-white/5 rounded-full blur-[120px]"
      />
    </div>
  );
}
