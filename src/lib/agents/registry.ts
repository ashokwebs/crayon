...
export const AGENTS: AgentDefinition[] = [
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    icon: 'Brain',
    gradient: 'from-zinc-800 to-purple-600',
  ...
  },
  {
    ...
    icon: 'DollarSign',
    gradient: 'from-indigo-400 to-zinc-950',
  ...
  },
  {
    ...
    icon: 'Shield',
    gradient: 'from-zinc-800 to-red-600',
    glowColor: 'shadow-black/20',
    accentHex: '#f43f5e',
    status: 'Online',
    aicoo: {
